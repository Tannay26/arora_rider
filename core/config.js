(() => {
  ...
  AR.ALLY_BLUEPRINTS = [
    { id: "bladePup", name: "Blade Pup", cost: 18, hp: 88, damage: 14, range: 46, attackSpeed: 1.35, speed: 105, type: "melee", xp: 0, level: 1, size: 0.82, role: "duelist", ranged: false },
    { id: "thornHare", name: "Thorn Hare", cost: 25, hp: 62, damage: 12, range: 255, attackSpeed: 0.95, speed: 88, type: "ranged", xp: 0, level: 1, size: 0.92, role: "archer", ranged: true },
    ...
    { id: "emberFox", name: "Ember Fox", cost: 34, hp: 76, damage: 9, range: 190, attackSpeed: 1.18, speed: 115, type: "burn", xp: 0, level: 1, size: 0.86, role: "skirmisher", ranged: true },
    ...
    { id: "frostOwl", name: "Frost Owl", cost: 39, hp: 70, damage: 10, range: 270, attackSpeed: 0.9, speed: 72, type: "slow", xp: 0, level: 1, size: 0.88, role: "control", ranged: true },
    { id: "sparkLynx", name: "Spark Lynx", cost: 47, hp: 78, damage: 15, range: 225, attackSpeed: 0.85, speed: 124, type: "chain", xp: 0, level: 1, size: 0.9, role: "arc", ranged: true },
    ...
    { id: "windCrane", name: "Wind Crane", cost: 56, hp: 74, damage: 19, range: 330, attackSpeed: 0.75, speed: 84, type: "longshot", xp: 0, level: 1, size: 1, role: "lancer", ranged: true },
  ...
  AR.UPGRADES = [
    ...
    { title: "+12% XP gain", apply: (game) => { game.mods.xpGain *= 1.12; } },
  ];

  AR.TRAINING_STATS = [
    { key: "damage", label: "DMG", multiplier: 1.1 },
    { key: "health", label: "HP", multiplier: 1.12 },
    { key: "attackSpeed", label: "ASPD", multiplier: 1.08 },
